...
function cardPrint(container) {
    ...
    for (var key in cards) {
        var card = '<div class="card border-info rounded mb-3">'
        card += '<img src="' + cards[key].pic + '" class="card-img-top" alt="..."></img>'
        card += '<div class="card-body">'
        card += '<h5 class="card-title text-info text-center">' + cards[key].title + '</h5>'
        card += '<p class="card-text text-justify">' + cards[key].desc + '</p>'
        card += '<p class="card-text"><small class="text-muted">Last updated 3 mins ago</small></p></div></div>'
...
function termsPrint(container){
    var terms = 'Terms and Conditions for Company Name\
     Introduction\
    ...
    document.getElementById(container).innerHTML += terms;
}
